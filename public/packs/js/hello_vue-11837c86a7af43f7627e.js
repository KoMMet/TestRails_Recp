...
// Module
exports.push([module.i, "\np[data-v-6fb8108a] {\n  font-size: 2em;\n  text-align: center;\n}\n", "",{"version":3,"sources":["/home/ubuntu/web/recp/app/javascript/app/javascript/app.vue"],"names":[],"mappings":";AAuCA;EACA,cAAA;EACA,kBAAA;AACA","file":"app.vue","sourcesContent":["<template>\n  <div id=\"app\">\n    <table>\n      <tbody>\n        <tr>\n          <th>ID</th>\n          <th>name</th>\n          <th>pass</th>\n          <th>jointime</th>\n        </tr>\n        <tr v-for=\"e in tusers\" :key=\"e.id\">\n          <td>{{ e.id }}</td>\n          <td>{{ e.name }}</td>\n          <td>{{ e.pass}}</td>\n          <td>{{ e.jointime }}</td>\n        </tr>\n      </tbody>\n    </table>\n  </div>\n</template>\n\n<script>\nimport axios from 'axios';\n\nexport default {\n  data: function () {\n    return {\n      tusers: []\n    }\n  },\n  mounted () {\n    axios\n      .get('/api/v1/tusers.json')\n      .then(response => (this.tusers = response.data))\n  }\n}\n</script>\n\n<style scoped>\np {\n  font-size: 2em;\n  text-align: center;\n}\n</style>\n"]}]);
// Exports
        ...
        [
          ...
          _vm._l(_vm.tusers, function(e) {
            return _c("tr", { key: e.id }, [
              ...
              _vm._v(" "),
              _c("td", [_vm._v(_vm._s(e.pass))]),
              _vm._v(" "),
              _c("td", [_vm._v(_vm._s(e.jointime))])
            ])
          })
        ],
        2
...
/******/ });
//# sourceMappingURL=hello_vue-11837c86a7af43f7627e.js.map