...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_0___default.a.get('/api/v1/employees.json').then(function (response) {
...
// Module
exports.push([module.i, "\np[data-v-6fb8108a] {\n  font-size: 2em;\n  text-align: center;\n}\n", "",{"version":3,"sources":["/home/ubuntu/web/recp/app/javascript/app/javascript/app.vue"],"names":[],"mappings":";AAmCA;EACA,cAAA;EACA,kBAAA;AACA","file":"app.vue","sourcesContent":["<template>\n  <div id=\"app\">\n    <table>\n      <tbody>\n        <tr>\n          <th>ID</th>\n          <th>name</th>\n        </tr>\n        <tr v-for=\"e in tusers\" :key=\"e.id\">\n          <td>{{ e.id }}</td>\n          <td>{{ e.name }}</td>\n        </tr>\n      </tbody>\n    </table>\n  </div>\n</template>\n\n<script>\nimport axios from 'axios';\n\nexport default {\n  data: function () {\n    return {\n      tusers: []\n    }\n  },\n  mounted () {\n    axios\n      .get('/api/v1/employees.json')\n      .then(response => (this.tusers = response.data))\n  }\n}\n</script>\n\n<style scoped>\np {\n  font-size: 2em;\n  text-align: center;\n}\n</style>\n"]}]);
// Exports
...
/******/ });
//# sourceMappingURL=hello_vue-bff4c056398b07928e59.js.map